...
export default function Footer() {
    ...
    const handleActiveButton = (e: any) =>{
    setActiveButton(e.target.name)
}
  return (
    <div className='w-full h-full '>
        <div className="flex flex-col items-center custom-background w-full h-[700px]">
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-screen-lg'>
                        <div className='w-full'>
                            <button name='about' className='text-3xl w-full text-left border-2 border-pale_yellow p-2 hover:bg-pale_yellow hover:text-black' onClick={handleActiveButton}>1. What services does Belz Construction Company provide?</button>
                            <p className={activeButton === 'about' ? 'block p-4' : 'hidden'}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                        <div className='w-full'>
                            <button name='blog' className='text-3xl w-full text-left border-2 border-pale_yellow p-2 hover:bg-pale_yellow hover:text-black' onClick={handleActiveButton}>2. Where is the office of Belz Construction Company located?</button>
                            <p className={activeButton === 'blog' ? 'block p-4' : 'hidden'}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                        <div className='w-full'>
                            <button name='contact' className='text-3xl w-full text-left border-2 border-pale_yellow p-2 hover:bg-pale_yellow hover:text-black' onClick={handleActiveButton}>3. What types of construction projects does Belz Construction Company specialize in</button>
                            <p className={activeButton === 'contact' ? 'block p-4' : 'hidden'}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
                        <div className='w-full'>
                            <button name='about' className='text-3xl w-full text-left border-2 border-pale_yellow p-2 hover:bg-pale_yellow hover:text-black' onClick={handleActiveButton}>1. About Us</button> 
                            <p className={activeButton === 'about' ? 'block p-4' : 'hidden'}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
                        </div>
        ...
        <div className="container px-5 py-24  mx-auto flex md:items-center lg:items-start  md:flex-nowrap flex-wrap flex-col">
            <div className="w-[100%] flex-shrink-0 md:mx-0 mx-auto text-center md:text-left flex justify-between items-center flex-col md:flex-row">
                    ...
                    <CustomButton route='/contact' text='Contact Us' styles='rounded-[50px] w-[276px] h-[54px] text-white bg-yellow text-xl font-normal flex justify-center items-center hover:bg-black hover:text-White'></CustomButton>
                   
            </div>

            <div className='w-[100%] h-[2px] bg-yellow mt-5 mb-5'></div>

            <div className="w-[90%] flex-grow flex flex-row flex-wrap  md:text-left text-center text-white">
                <div className='w-[30%]'>
